 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var jv;function B_(){if(jv)return je;jv=1;var i=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),a=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),c=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),f=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),v=Symbol.iterator;function x(k){return k===null||typeof k!="object"?null:(k=v&&k[v]||k["@@iterator"],typeof k=="function"?k:null)}var w={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},S=Object.assign,T={};function E(k,X,ue){this.props=k,this.context=X,this.refs=T,this.updater=ue||w}E.prototype.isReactComponent={},E.prototype.setState=function(k,X){if(typeof k!="object"&&typeof k!="function"&&k!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,k,X,"setState")},E.prototype.forceUpdate=function(k){this.updater.enqueueForceUpdate(this,k,"forceUpdate")};function j(){}j.prototype=E.prototype;function D(k,X,ue){this.props=k,this.context=X,this.refs=T,this.updater=ue||w}var M=D.prototype=new j;M.constructor=D,S(M,E.prototype),M.isPureReactComponent=!0;var V=Array.isArray,P={H:null,A:null,T:null,S:null},R=Object.prototype.hasOwnProperty;function F(k,X,ue,oe,ne,_e){return ue=_e.ref,{$$typeof:i,type:k,key:X,ref:ue!==void 0?ue:null,props:_e}}function I(k,X){return F(k.type,X,void 0,void 0,void 0,k.props)}function G(k){return typeof k=="object"&&k!==null&&k.$$typeof===i}function te(k){var X={"=":"=0",":":"=2"};return"$"+k.replace(/[=:]/g,function(ue){return X[ue]})}var he=/\/+/g;function Ae(k,X){return typeof k=="object"&&k!==null&&k.key!=null?te(""+k.key):X.toString(36)}function Ne(){}function Fe(k){switch(k.status){case"fulfilled":return k.value;case"rejected":throw k.reason;default:switch(typeof k.status=="string"?k.then(Ne,Ne):(k.status="pending",k.then(function(X){k.status==="pending"&&(k.status="fulfilled",k.value=X)},function(X){k.status==="pending"&&(k.status="rejected",k.reason=X)})),k.status){case"fulfilled":return k.value;case"rejected":throw k.reason}}throw k}function qe(k,X,ue,oe,ne){var _e=typeof k;(_e==="undefined"||_e==="boolean")&&(k=null);var ye=!1;if(k===null)ye=!0;else switch(_e){case"bigint":case"string":case"number":ye=!0;break;case"object":switch(k.$$typeof){case i:case t:ye=!0;break;case g:return ye=k._init,qe(ye(k._payload),X,ue,oe,ne)}}if(ye)return ne=ne(k),ye=oe===""?"."+Ae(k,0):oe,V(ne)?(ue="",ye!=null&&(ue=ye.replace(he,"$&/")+"/"),qe(ne,X,ue,"",function(Ie){return Ie})):ne!=null&&(G(ne)&&(ne=I(ne,ue+(ne.key==null||k&&k.key===ne.key?"":(""+ne.key).replace(he,"$&/")+"/")+ye)),X.push(ne)),1;ye=0;var dt=oe===""?".":oe+":";if(V(k))for(var Oe=0;Oe<k.length;Oe++)oe=k[Oe],_e=dt+Ae(oe,Oe),ye+=qe(oe,X,ue,_e,ne);else if(Oe=x(k),typeof Oe=="function")for(k=Oe.call(k),Oe=0;!(oe=k.next()).done;)oe=oe.value,_e=dt+Ae(oe,Oe++),ye+=qe(oe,X,ue,_e,ne);else if(_e==="object"){if(typeof k.then=="function")return qe(Fe(k),X,ue,oe,ne);throw X=String(k),Error("Objects are not valid as a React child (found: "+(X==="[object Object]"?"object with keys {"+Object.keys(k).join(", ")+"}":X)+"). If you meant to render a collection of children, use an array instead.")}return ye}function W(k,X,ue){if(k==null)return k;var oe=[],ne=0;return qe(k,oe,"","",function(_e){return X.call(ue,_e,ne++)}),oe}function re(k){if(k._status===-1){var X=k._result;X=X(),X.then(function(ue){(k._status===0||k._status===-1)&&(k._status=1,k._result=ue)},function(ue){(k._status===0||k._status===-1)&&(k._status=2,k._result=ue)}),k._status===-1&&(k._status=0,k._result=X)}if(k._status===1)return k._result.default;throw k._result}var Q=typeof reportError=="function"?reportError:function(k){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var X=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof k=="object"&&k!==null&&typeof k.message=="string"?String(k.message):String(k),error:k});if(!window.dispatchEvent(X))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",k);return}console.error(k)};function ae(){}return je.Children={map:W,forEach:function(k,X,ue){W(k,function(){X.apply(this,arguments)},ue)},count:function(k){var X=0;return W(k,function(){X++}),X},toArray:function(k){return W(k,function(X){return X})||[]},only:function(k){if(!G(k))throw Error("React.Children.only expected to receive a single React element child.");return k}},je.Component=E,je.Fragment=r,je.Profiler=o,je.PureComponent=D,je.StrictMode=a,je.Suspense=f,je.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,je.act=function(){throw Error("act(...) is not supported in production builds of React.")},je.cache=function(k){return function(){return k.apply(null,arguments)}},je.cloneElement=function(k,X,ue){if(k==null)throw Error("The argument must be a React element, but you passed "+k+".");var oe=S({},k.props),ne=k.key,_e=void 0;if(X!=null)for(ye in X.ref!==void 0&&(_e=void 0),X.key!==void 0&&(ne=""+X.key),X)!R.call(X,ye)||ye==="key"||ye==="__self"||ye==="__source"||ye==="ref"&&X.ref===void 0||(oe[ye]=X[ye]);var ye=arguments.length-2;if(ye===1)oe.children=ue;else if(1<ye){for(var dt=Array(ye),Oe=0;Oe<ye;Oe++)dt[Oe]=arguments[Oe+2];oe.children=dt}return F(k.type,ne,void 0,void 0,_e,oe)},je.createContext=function(k){return k={$$typeof:c,_currentValue:k,_currentValue2:k,_threadCount:0,Provider:null,Consumer:null},k.Provider=k,k.Consumer={$$typeof:u,_context:k},k},je.createElement=function(k,X,ue){var oe,ne={},_e=null;if(X!=null)for(oe in X.key!==void 0&&(_e=""+X.key),X)R.call(X,oe)&&oe!=="key"&&oe!=="__self"&&oe!=="__source"&&(ne[oe]=X[oe]);var ye=arguments.length-2;if(ye===1)ne.children=ue;else if(1<ye){for(var dt=Array(ye),Oe=0;Oe<ye;Oe++)dt[Oe]=arguments[Oe+2];ne.children=dt}if(k&&k.defaultProps)for(oe in ye=k.defaultProps,ye)ne[oe]===void 0&&(ne[oe]=ye[oe]);return F(k,_e,void 0,void 0,null,ne)},je.createRef=function(){return{current:null}},je.forwardRef=function(k){return{$$typeof:h,render:k}},je.isValidElement=G,je.lazy=function(k){return{$$typeof:g,_payload:{_status:-1,_result:k},_init:re}},je.memo=function(k,X){return{$$typeof:p,type:k,compare:X===void 0?null:X}},je.startTransition=function(k){var X=P.T,ue={};P.T=ue;try{var oe=k(),ne=P.S;ne!==null&&ne(ue,oe),typeof oe=="object"&&oe!==null&&typeof oe.then=="function"&&oe.then(ae,Q)}catch(_e){Q(_e)}finally{P.T=X}},je.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},je.use=function(k){return P.H.use(k)},je.useActionState=function(k,X,ue){return P.H.useActionState(k,X,ue)},je.useCallback=function(k,X){return P.H.useCallback(k,X)},je.useContext=function(k){return P.H.useContext(k)},je.useDebugValue=function(){},je.useDeferredValue=function(k,X){return P.H.useDeferredValue(k,X)},je.useEffect=function(k,X){return P.H.useEffect(k,X)},je.useId=function(){return P.H.useId()},je.useImperativeHandle=function(k,X,ue){return P.H.useImperativeHandle(k,X,ue)},je.useInsertionEffect=function(k,X){return P.H.useInsertionEffect(k,X)},je.useLayoutEffect=function(k,X){return P.H.useLayoutEffect(k,X)},je.useMemo=function(k,X){return P.H.useMemo(k,X)},je.useOptimistic=function(k,X){return P.H.useOptimistic(k,X)},je.useReducer=function(k,X,ue){return P.H.useReducer(k,X,ue)},je.useRef=function(k){return P.H.useRef(k)},je.useState=function(k){return P.H.useState(k)},je.useSyncExternalStore=function(k,X,ue){return P.H.useSyncExternalStore(k,X,ue)},je.useTransition=function(){return P.H.useTransition()},je.version="19.0.0",je}var Rv;function Jp(){return Rv||(Rv=1,oh.exports=B_()),oh.exports}var _=Jp();const Pi=Ms(_);var lh={exports:{}},No={},uh={exports:{}},ch={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Cv;function V_(){return Cv||(Cv=1,function(i){function t(W,re){var Q=W.length;W.push(re);e:for(;0<Q;){var ae=Q-1>>>1,k=W[ae];if(0<o(k,re))W[ae]=re,W[Q]=k,Q=ae;else break e}}function r(W){return W.length===0?null:W[0]}function a(W){if(W.length===0)return null;var re=W[0],Q=W.pop();if(Q!==re){W[0]=Q;e:for(var ae=0,k=W.length,X=k>>>1;ae<X;){var ue=2*(ae+1)-1,oe=W[ue],ne=ue+1,_e=W[ne];if(0>o(oe,Q))ne<k&&0>o(_e,oe)?(W[ae]=_e,W[ne]=Q,ae=ne):(W[ae]=oe,W[ue]=Q,ae=ue);else if(ne<k&&0>o(_e,Q))W[ae]=_e,W[ne]=Q,ae=ne;else break e}}return re}function o(W,re){var Q=W.sortIndex-re.sortIndex;return Q!==0?Q:W.id-re.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var c=Date,h=c.now();i.unstable_now=function(){return c.now()-h}}var f=[],p=[],g=1,v=null,x=3,w=!1,S=!1,T=!1,E=typeof setTimeout=="function"?setTimeout:null,j=typeof clearTimeout=="function"?clearTimeout:null,D=typeof setImmediate<"u"?setImmediate:null;function M(W){for(var re=r(p);re!==null;){if(re.callback===null)a(p);else if(re.startTime<=W)a(p),re.sortIndex=re.expirationTime,t(f,re);else break;re=r(p)}}function V(W){if(T=!1,M(W),!S)if(r(f)!==null)S=!0,Fe();else{var re=r(p);re!==null&&qe(V,re.startTime-W)}}var P=!1,R=-1,F=5,I=-1;function G(){return!(i.unstable_now()-I<F)}function te(){if(P){var W=i.unstable_now();I=W;var re=!0;try{e:{S=!1,T&&(T=!1,j(R),R=-1),w=!0;var Q=x;try{t:{for(M(W),v=r(f);v!==null&&!(v.expirationTime>W&&G());){var ae=v.callback;if(typeof ae=="function"){v.callback=null,x=v.priorityLevel;var k=ae(v.expirationTime<=W);if(W=i.unstable_now(),typeof k=="function"){v.callback=k,M(W),re=!0;break t}v===r(f)&&a(f),M(W)}else a(f);v=r(f)}if(v!==null)re=!0;else{var X=r(p);X!==null&&qe(V,X.startTime-W),re=!1}}break e}finally{v=null,x=Q,w=!1}re=void 0}}finally{re?he():P=!1}}}var he;if(typeof D=="function")he=function(){D(te)};else if(typeof MessageChannel<"u"){var Ae=new MessageChannel,Ne=Ae.port2;Ae.port1.onmessage=te,he=function(){Ne.postMessage(null)}}else he=function(){E(te,0)};function Fe(){P||(P=!0,he())}function qe(W,re){R=E(function(){W(i.unstable_now())},re)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(W){W.callback=null},i.unstable_continueExecution=function(){S||w||(S=!0,Fe())},i.unstable_forceFrameRate=function(W){0>W||125<W?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<W?Math.floor(1e3/W):5},i.unstable_getCurrentPriorityLevel=function(){return x},i.unstable_getFirstCallbackNode=function(){return r(f)},i.unstable_next=function(W){switch(x){case 1:case 2:case 3:var re=3;break;default:re=x}var Q=x;x=re;try{return W()}finally{x=Q}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(W,re){switch(W){case 1:case 2:case 3:case 4:case 5:break;default:W=3}var Q=x;x=W;try{return re()}finally{x=Q}},i.unstable_scheduleCallback=function(W,re,Q){var ae=i.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ae+Q:ae):Q=ae,W){case 1:var k=-1;break;case 2:k=250;break;case 5:k=1073741823;break;case 4:k=1e4;break;default:k=5e3}return k=Q+k,W={id:g++,callback:re,priorityLevel:W,startTime:Q,expirationTime:k,sortIndex:-1},Q>ae?(W.sortIndex=Q,t(p,W),r(f)===null&&W===r(p)&&(T?(j(R),R=-1):T=!0,qe(V,Q-ae))):(W.sortIndex=k,t(f,W),S||w||(S=!0,Fe())),W},i.unstable_shouldYield=G,i.unstable_wrapCallback=function(W){var re=x;return function(){var Q=x;x=re;try{return W.apply(this,arguments)}finally{x=Q}}}}(ch)),ch}var kv;function $_(){return kv||(kv=1,uh.exports=V_()),uh.exports}var dh={exports:{}},Yt={};/**
 * @license React
...
`,f6=()=>{const i=_.useRef(null),t=_.useRef(null),[r,a]=_.useState(""),[o,u]=_.useState(!1),c="식식은 섭식장애에 그저 '이런 병이 있습니다'에서 그치지 않습니다. '함께' 할 수 있도록 공간을 마련하는 것, 그것이 바로 식식의 종착점입니다. 섭식장애 문제에 함께 목소리를 내는 것이 어려운 일이 되지 않도록 '고백접시 돌리기'는 그런 생각에서 부터 시작하게 되었습니다. 세 명의 식구들로부터 온 접시를 전달 받은 순간부터, 당신도 우리의 식구!",[h,f]=_.useState([]),[p,g]=_.useState("작성자명"),[v,x]=_.useState(1),[w,S]=_.useState(window.innerWidth),[T,E]=_.useState({}),[j,D]=_.useState(!1),M=w<=768?3:w<=1024?6:9;_.useEffect(()=>{V()},[]);const V=async()=>{try{D(!0);const{data:Q,error:ae}=await Nc.from("cheering").select("*").order("created_at",{ascending:!1});if(ae)console.error("데이터 불러오기 오류:",ae),alert("데이터를 불러오는 중 오류가 발생했습니다.");else{const k=Q.map(X=>({id:X.id,text:X.text,writer:X.name||"익명",plateType:X.plate_type||Math.floor(Math.random()*3)+1,date:new Date(X.created_at).toISOString().split("T")[0]}));f(k)}}catch(Q){console.error("데이터 불러오기 중 예외 발생:",Q),alert("데이터를 불러오는 중 오류가 발생했습니다.")}finally{D(!1)}};_.useEffect(()=>{const Q=()=>{S(window.innerWidth)};return window.addEventListener("resize",Q),()=>{window.removeEventListener("resize",Q)}},[]);const P=Q=>{const ae=Q.target.value;ae.replace(/\s/g,"").length<=180&&a(ae)},R=Q=>{const ae=Q.target.value;ae.replace(/\s/g,"").length<=8&&g(ae)},F=()=>{u(!0),r||a("")},I=()=>{u(!1),r.trim()||a("")},G=async()=>{if(!r.trim()){alert("메시지를 입력해주세요!");return}try{D(!0);const{data:Q,error:ae}=await Nc.from("cheering").insert([{name:p!=="작성자명"?p:"익명",text:r.trim(),plate_type:Math.floor(Math.random()*3)+1}]).select();if(ae){console.error("데이터 저장 오류:",ae),alert("메시지 저장 중 오류가 발생했습니다.");return}if(Q&&Q.length>0){const k={id:Q[0].id,text:Q[0].text,writer:Q[0].name||"익명",plateType:Q[0].plate_type,date:new Date(Q[0].created_at).toISOString().split("T")[0]};f(X=>[k,...X]),x(1),a(""),p!=="작성자명"&&g("작성자명"),alert("고백접시가 등록되었습니다!")}}catch(Q){console.error("메시지 저장 중 예외 발생:",Q),alert("메시지 저장 중 오류가 발생했습니다.")}finally{D(!1)}},te=()=>{if(i.current){const Q=i.current.getBoundingClientRect(),ae=window.scrollY+Q.top;window.scrollTo({top:ae-95,behavior:"smooth"})}},he=Q=>{E(ae=>({...ae,[Q]:!ae[Q]}))},Ae=()=>{const Q=(v-1)*M,ae=Q+M;return h.slice(Q,ae).map((k,X)=>({...k,plateType:(Q+X)%3+1}))},Ne=()=>Math.ceil(h.length/M),Fe=Q=>{x(Q)},qe=()=>{p==="작성자명"&&g("")},W=()=>{p.trim()||g("작성자명")},re=()=>p==="작성자명"?8:8-p.replace(/\s/g,"").length;return y.jsxs(h6,{children:[y.jsxs(p6,{children:[y.jsx(m6,{children:"고백접시 돌리기"}),y.jsxs(g6,{children:[y.jsx(dp,{children:"식구들에게 남긴 응원의 메세지가"}),y.jsx(dp,{children:"담긴 고백접시입니다."}),y.jsx(dp,{children:"식구들과 함께 고백접시를 돌려볼까요?"})]})]}),y.jsx(y6,{children:y.jsx(v6,{children:y.jsxs(x6,{children:[y.jsx(Mt,{children:y.jsx(zt,{src:ia,alt:"Plate 1"})}),y.jsx(Mt,{children:y.jsx(zt,{src:na,alt:"Plate 2"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ra,alt:"Plate 3"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ia,alt:"Plate 1"})}),y.jsx(Mt,{children:y.jsx(zt,{src:na,alt:"Plate 2"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ra,alt:"Plate 3"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ia,alt:"Plate 1"})}),y.jsx(Mt,{children:y.jsx(zt,{src:na,alt:"Plate 2"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ra,alt:"Plate 3"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ia,alt:"Plate 1"})}),y.jsx(Mt,{children:y.jsx(zt,{src:na,alt:"Plate 2"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ra,alt:"Plate 3"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ia,alt:"Plate 1"})}),y.jsx(Mt,{children:y.jsx(zt,{src:na,alt:"Plate 2"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ra,alt:"Plate 3"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ia,alt:"Plate 1"})}),y.jsx(Mt,{children:y.jsx(zt,{src:na,alt:"Plate 2"})}),y.jsx(Mt,{children:y.jsx(zt,{src:ra,alt:"Plate 3"})})]})})}),y.jsx(b6,{ref:i,children:y.jsx(w6,{onClick:te,children:y.jsx(S6,{src:c6,alt:"Down Arrow"})})}),y.jsxs(A6,{children:[y.jsx(_6,{children:y.jsx(E6,{children:"고백접시 돌리기"})}),y.jsxs(T6,{children:[y.jsx(fp,{children:y.jsx(hp,{children:"❶ 고백접시 돌리기 버튼을 눌러 응원의 메세지를 남긴다."})}),y.jsx(fp,{children:y.jsx(hp,{children:"❷ 고백접시를 눌러 글을 읽어본다."})}),y.jsx(fp,{children:y.jsx(hp,{children:"❸ 든든한 마음과 함께 식식의 식구가 된다."})})]}),y.jsx(j6,{ref:t,children:y.jsxs(R6,{children:[y.jsxs(C6,{children:[y.jsx(k6,{children:"작성자"}),y.jsx(D6,{children:"|"}),y.jsx(O6,{value:p,onChange:R,onFocus:qe,onBlur:W,isfocused:p!=="작성자명"?"true":"false"}),p!=="작성자명"&&y.jsxs(M6,{children:[re(),"자 남음"]})]}),y.jsx(z6,{placeholder:c,value:o||r?r:c,onChange:P,onFocus:F,onBlur:I,isfocused:o||r.length>0?"true":"false"}),(o||r)&&y.jsxs(L6,{children:[180-r.replace(/\s/g,"").length,"자 남음"]}),y.jsx(P6,{}),y.jsx(U6,{children:y.jsxs(N6,{onClick:G,disabled:j,children:[y.jsx(B6,{}),j?"등록 중...":"고백접시 돌리기"]})})]})}),j&&h.length===0?y.jsx(V6,{children:"메시지를 불러오는 중..."}):h.length>0?y.jsx($6,{children:y.jsx(H6,{windowWidth:w,children:Ae().map(Q=>y.jsxs(q6,{onClick:()=>he(Q.id),children:[y.jsx(G6,{src:Q.plateType===1?ia:Q.plateType===2?na:ra,alt:`Plate ${Q.plateType}`}),y.jsxs(F6,{isClicked:T[Q.id],children:[y.jsx(I6,{children:Q.writer}),y.jsx(Y6,{children:Q.text}),y.jsx(K6,{children:Q.date})]})]},Q.id))})}):null,h.length>0&&y.jsx(X6,{children:Array.from({length:Ne()},(Q,ae)=>y.jsx(Q6,{className:v===ae+1?"active":"",onClick:()=>Fe(ae+1),children:ae+1},ae+1))})]})]})},h6=O.div`
  width: 100%;
  height: auto;
  min-height: 100%;
  display: flex;
